...
function pageHome() {
    ...
    +       '<a href="https://github.com/Copper-Linux" target="_blank" class="btn">GITHUB</a>'
    +     '</div>'
    +   '</div>'
    + '</section>'
...
function pageDailyDriving() {
    ...
    +         '<li>Better coding compatibility</li>'
    +       '</ul>'
    +     '</div>'
    +   '</div>'
    + '</section>'
    ...
    +   '<div class="container">'
    +     '<h2>Get Copper Linux</h2>'
    +     '<p style="color:var(--dim)">We are currently in active development. ISO downloads are coming soon.</p>'
    +     '<div class="terminal-block" style="max-width:360px;margin:20px auto;text-align:left">'
    +       '$ copper --status<br>Copper Linux<br>Building from source required.'
    +     '</div>'
    +     '<a href="https://github.com/Copper-Linux" target="_blank" class="btn btn-accent" style="margin-top:16px">VIEW ON GITHUB</a>'
    +   '</div>'
    + '</section>';
}
...
function pageTools() {
    ...
    +     '<p class="page-subtitle">Vortex Linux security toolkit — coming soon.</p>'
    +   '</div>'
    + '</section>'
    ...
    +       '<strong>Currently in development.</strong> Vortex Linux does not yet ship with any preinstalled tools. '
    +       'We are still in early development and the security toolkit will be added as the project matures. '
    +       'Check back here as things progress.'
    +     '</div>'
    +   '</div>'
    + '</section>'
    ...
    +     '<div class="terminal-block" style="max-width:480px;margin:0 auto;text-align:left">'
    +       '$ vortex --tools list<br>'
    +       'No tools installed yet.<br>'
    +       'Status: In Development<br>'
    +       'ETA:    Unknown'
    +     '</div>'
    +     '<p style="color:var(--dim);margin-top:24px;font-size:0.9rem">Want to help? Contribute by packaging tools via a pull request.</p>'
    +     '<div class="btn-group" style="justify-content:center;margin-top:20px">'
    +       '<a href="https://github.com/Copper-Linux" target="_blank" class="btn btn-accent">GITHUB →</a>'
    +       '<a href="#/contributions" class="btn">HOW TO CONTRIBUTE</a>'
    +     '</div>'
    +   '</div>'
    + '</section>';
}
...
function pageContributions() {
    ...
    +       '<a href="https://github.com/Copper-Linux" target="_blank" class="btn">GITHUB REPOSITORY</a>'
